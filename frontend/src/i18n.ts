...
const en = {
  ...
  admin: {
    ...
    visualSandbox: {
      ...
      potentialBoost: "+{pct}% potential boost",
      seeAllIssues: "See all issues ({count})",
      ...
      autoImproveBannerCta: "See how to improve →",
      previewTitle: "Preview your optimized resume",
      previewSubtitle: "See how your resume looks with a professional design.",
