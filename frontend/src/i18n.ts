...
const en = {
  ...
  optimize: {
    ...
    freeLimitWallTitle: "You've used your free resume check",
    freeLimitWallSubtitle:
      "On the Free plan you get one ATS-style scan. To run new checks, tailor your resume to more jobs, and unlock AI optimization with PDF export, upgrade or start a 7-day trial.",
    freeLimitWallEditSetup: "Change resume or job",
