  ...
  admin: {
    ...
    email: {
      ...
      send: {
        ...
        tabMain: "Main",
        tabTools: "Advanced",
        mainFlowsTitle: "Email flows",
        mainFlowsSubtitle:
          "Every registered flow is listed. Only flows that already have a server hook + admin form show controls here; the rest show status until you wire them in code (or we add DB-driven rules later).",
        flowCompactHint: "No form on this page yet — logic lives in the API. See Advanced → Developer reference.",
        flowJumpSegment: "Scroll to segment send",
        howToAddTitle: "How to add, remove, or change a flow",
        howToAddIntro:
          "Today automations are code-first. Full “pick template + conditions + delete in UI” needs a new DB model and a small rules engine — not shipped yet. Until then:",
        howToAdd1: "Add or remove an entry in email_automation_registry.py (stable id, wired flag).",
        howToAdd2: "Implement when it runs and how it sends (Python: queue, cron, or hook after an event).",
        howToAdd3: "If users should pick Resend templates here, store template ids in Postgres and extend PATCH /admin/email/control or a new endpoint.",
        howToAdd4: "Add this flow’s id to AUTOMATION_MAIN_EDITOR_IDS in AdminEmailSend.tsx when you build its form; reuse getAdminResendTemplates() for template pickers.",
