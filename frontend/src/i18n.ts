...
const en = {
  ...
  admin: {
    ...
    email: {
      groups: {
        title: "Email groups",
        subtitle: "Build recipient segments from filters (e.g. optimized but no paid download). Sync to Resend will be wired next.",
        resendNoteTitle: "Resend API key",
        resendNoteBody:
          "Put your key only in server environment variables (e.g. RESEND_API_KEY). Never paste API keys into the frontend or git. If a key was shared in chat, revoke it in Resend and create a new one.",
        savedSegments: "Saved segments",
        savedSegmentsHint: "Placeholder list — persistence and filters coming later.",
      ...
      templates: {
        ...
        assetUrlsHint:
          "Files live under frontend/public and are copied into the SPA build. After git push, your host (e.g. Railway auto-deploy) serves them at these paths — use them in Resend instead of {{logo_url}} / {{hero_image_url}}, or substitute at send time.",
