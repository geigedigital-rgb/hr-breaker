/** English UI / admin strings (source of truth for keys). */
...
const en = {
  ...
  notifications: {
    ...
    dismiss: "Dismiss",
    welcomeTitle: "Welcome to PitchCV!",
    welcomeMessage:
      "You have 10 ATS scans and 10 optimizations each month on Free. Add a resume and job to see your match score.",
    welcomeAction: "Get started",
    upsellTitle: "Great start!",
    upsellMessage:
      "You've successfully analyzed your resume. Keep going! Let's optimize it so recruiters can't miss you.",
    upsellAction: "Unlock AI Optimization",
    trialTitle: "Trial ending soon",
    trialMessage: "Your trial ends in {days} days. Make sure to download all your optimized resumes!",
  },
  emailUnsubscribed: {
  ...
  partner: {
    ...
    welcomeBannerTitle: "You’re a partner now — congratulations!",
    welcomeBannerBody:
      "An administrator enabled partner access for your account. Open your partner dashboard to copy your referral link and track signups and earnings.",
    welcomeBannerCta: "Open partner dashboard",
    welcomeBannerDismiss: "Dismiss",
    subtitle:
      "Invite friends and earn from their first paid monthly subscription (after any trial). You manage your earnings here.",
    ...
    shareLinkHint:
      "Anyone who signs up via this link and later has an active paid monthly plan counts as your referral.",
    rules: "Partner rules",
    ...
    emptyHint:
      "Share your link — when someone’s paid monthly subscription starts (after trial), you earn 30% of that first subscription charge.",
    ...
    dash: {
      heroTotalEarned: "Total earned",
      heroAvailableWithdraw: "Available to withdraw",
      payoutProgressLabel: "Payout progress",
      payoutProgressHint: "Reach {amount} to unlock payouts",
      referralLinkLabel: "Your referral link",
      earnBlurb: "Earn for every paid user you refer",
      metricsClicks: "Clicks",
      metricsSignups: "Signups",
      metricsPaidUsers: "Paid users",
      metricsConversion: "Conversion rate",
      referralsTitle: "Referrals",
      referralsColUser: "User",
      referralsColStatus: "Status",
      referralsColPlan: "Plan",
      referralsPlanWelcome: "Welcome bonus",
      referralsUserPitchCV: "PitchCV team",
      referralsColEarned: "Earned",
      referralsColDate: "Date",
      referralsViewFull: "View all referrals",
      referralsModalTitle: "Referrals",
      statusPaid: "Paid",
      ...
      leaderboardPeriodHint: "Последний месяц",
      leaderboardYou: "You",
      leaderboardViewFull: "View full leaderboard",
      leaderboardEmpty: "No partners yet",
      leaderboardColRank: "Rank",
      leaderboardColPartner: "Partner",
      leaderboardColPaidOut: "Paid out",
      leaderboardColPaidOutHint: "Actually transferred to partner",
      leaderboardColBooked: "Booked total",
      leaderboardColBookedHint:
        "Extra pipeline in this period (approved + on hold). Shown only when booked exceeds paid out.",
      leaderboardColApproved: "Approved (pending payout)",
      leaderboardColOnHold: "On review",
      leaderboardColRows: "Commissions",
      leaderboardModalTitle: "Partner leaderboard",
      leaderboardPrev: "Previous",
      leaderboardNext: "Next",
      leaderboardPageOf: "Page {page} of {totalPages}",
      leaderboardLoadError: "Could not load leaderboard",
      rulesFooterTitle: "Rules",
      rulesFooterSelf: "No self-referrals",
      rulesFooterManual: "Payouts are processed manually after approval",
      noData: "—",
      withdrawModalTitle: "Withdraw funds",
      withdrawModalClose: "Close",
      withdrawProgressTitle: "Your current payout progress",
      withdrawAccountName: "Account name",
      withdrawTotalBalance: "Available balance",
      withdrawDesired: "Desired withdrawal",
      withdrawMinPayout: "Minimum payout: {amount}",
      withdrawPayoutMethod: "Payout method",
      withdrawMethodCard: "Card number",
      withdrawMethodSepa: "SEPA",
      withdrawMethodCrypto: "Crypto",
      withdrawSubmit: "Submit withdrawal",
      withdrawBannerThreshold: "Withdrawal available upon reaching {amount}.",
    },
  },
  improveResume: {
    ...
    uploading: "Uploading…",
    uploadedLabel: "Resume ready",
    changeResume: "Change",
    improveTitle: "Improve my resume",
    improveTag: "Fastest option",
    improveDesc: "Get instant feedback, stronger wording, and a cleaner, more professional resume.",
    improveBtn: "Improve my resume",
    tailorTitle: "Tailor to a job",
    tailorTag: "Stronger match",
    tailorDesc: "Match your resume to a job description, improve ATS keywords, and increase your chances of getting interviews.",
    jobPlaceholder: "Paste job URL or job description here…",
    tailorBtn: "Tailor my resume",
    readFileError: "Could not read file",
  },
  home: {
    resumeMatchScore: "Match your resume to the job",
    resumeMatchDesc: "See your score, find missing keywords, and improve your chances of getting interviews.",
  ...
  optimize: {
    ...
    recommendationsTitleImprove: "Resume tips",
    ...
    recCategoryWriting: "Writing",
    recCategoryImpact: "Impact",
    improveModeStep2Title: "General improvement",
    improveModeStep2Sub: "No job posting needed — we review structure, wording, and impact.",
    improveModeRetryScan: "Analyze resume again",
    improveModeNoJobNeeded: "Runs without a vacancy — ATS-friendly tips only.",
    ...
    loaderHeroAnalysisTitle: "Analyzing your resume…",
    loaderHeroAnalysisDesc:
      "Our AI is reviewing your resume against the job description and identifying key areas to improve.",
    loaderHeroOptimizeTitle: "Optimizing your resume…",
    loaderHeroOptimizeDesc:
      "Keep this tab open — we\u2019ll finish in a moment. Full optimization can take up to 60 seconds.",
    pipelineAnalysisImprove1Sub: "Reading your resume content",
    pipelineAnalysisImprove2Sub: "Checking sections and flow",
    pipelineAnalysisImprove3Sub: "Scanning wording and tone",
    pipelineAnalysisImprove4Sub: "Improving clarity and impact",
    pipelineAnalysisImprove5Sub: "Computing readiness score",
    pipelineAnalysisTailor1Sub: "Pairing resume highlights with the role",
    pipelineAnalysisTailor2Sub: "Comparing with job requirements",
    pipelineAnalysisTailor3Sub: "Spotting keyword and skill gaps",
    pipelineAnalysisTailor4Sub: "Checking ATS signals and structure",
    pipelineAnalysisTailor5Sub: "Building your gap report",
    pipelineOptimizeImprove1Sub: "Refining headline and positioning",
    pipelineOptimizeImprove2Sub: "Strengthening bullet impact",
    pipelineOptimizeImprove3Sub: "Aligning skills with expectations",
    pipelineOptimizeImprove4Sub: "Polishing layout and spacing",
    pipelineOptimizeImprove5Sub: "Running checks and preparing PDF",
    pipelineOptimizeTailor1Sub: "Rewriting for this role",
    pipelineOptimizeTailor2Sub: "Embedding role keywords",
    pipelineOptimizeTailor3Sub: "Tuning tone and bullet depth",
    pipelineOptimizeTailor4Sub: "Balancing length and readability",
    pipelineOptimizeTailor5Sub: "Quality gates and validation",
    pipelineRestore1: "Secure session",
    pipelineRestore2: "Loading snapshot",
    pipelineRestore3: "Preparing editor",
    pipelineAnalysisImprove1: "Resume intake",
    pipelineAnalysisImprove2: "Structure",
    pipelineAnalysisImprove3: "Wording scan",
    pipelineAnalysisImprove4: "Clarity pass",
    pipelineAnalysisImprove5: "Readiness score",
    pipelineAnalysisTailor1: "Job pairing",
    pipelineAnalysisTailor2: "Requirements",
    pipelineAnalysisTailor3: "Keywords",
    pipelineAnalysisTailor4: "ATS signals",
    pipelineAnalysisTailor5: "Gap report",
    pipelineOptimizeImprove1: "Headline pass",
    pipelineOptimizeImprove2: "Bullets",
    pipelineOptimizeImprove3: "Skills pass",
    pipelineOptimizeImprove4: "Layout polish",
    pipelineOptimizeImprove5: "Checks & PDF",
    pipelineOptimizeTailor1: "Role rewrite",
    pipelineOptimizeTailor2: "Keywords",
    pipelineOptimizeTailor3: "Tone & bullets",
    pipelineOptimizeTailor4: "Length & layout",
    pipelineOptimizeTailor5: "Quality gates",
    ...
    workspace: {
      ...
      shareUnavailable: "Share link not available yet",
      export: "Export",
      exportResume: "Export resume",
      match: "Match",
      score: "Score",
      nextStep: "Next step",
      improvementsFound: "{count} improvements found",
      lookingGood: "Looking good — review tips",
      improveResume: "Improve resume",
      improveStronger: "Improve even stronger",
      ...
      barImpact: "Impact",
      barFormatting: "Formatting",
      scoresPending: "Detailed scores appear after analysis completes.",
      jobGeneral: "General resume improvement",
      resumeUntitled: "Your resume",
      jobEmpty: "No job posting for this run.",
      missingKeywords: "Missing keywords",
      whatChanged: "What changed",
      styleAfterImprove: "Pick a template and photo — the preview updates live.",
      styleFitAdjusted: "Content adjusted to fit 1 page",
      styleFitWarning: "Could not fully fit to one page — content was shortened as much as possible.",
      zoomOut: "Zoom out",
      zoomIn: "Zoom in",
      pagePrev: "Previous page",
      pageNext: "Next page",
      showMoreAnnotations: "Show more",
      showLessAnnotations: "Show less",
      tailorAnother: "Tailor another vacancy",
      editResume: "Resume content",
      editResumeText: "Edit resume text",
      actionsLocked: "Improve your resume first to unlock Share and Export",
      journeyPath: "Path",
      journeyProgress: "{done} / {total}",
      journeyAria: "Resume improvement path",
      journeyRecommendations: "Analysis",
      journeyImprove: "Improve",
      journeyStyle: "Styling",
      zoomHint: "Pinch or Ctrl+scroll to zoom the resume sheet",
      editorBold: "Bold",
      editorItalic: "Italic",
  ...
  progress: {
    title: "Progress",
    marketReadinessScore: "Market Readiness Score",
    howPointsEarned: "How points are earned",
    signInRequired: "Progress is available in your account. Sign in or sign up.",
    nextStep: "Next step",
  ...
  settings: {
    ...
    appLanguageHint: "Menus, buttons, and screens.",
    aiLanguage: "Resume / AI language",
    aiLanguageHint: "Language for tips, analysis, and generated resume text.",
    languageEn: "English",
    languageEs: "Español",
    languageRu: "Русский",
    notifications: "Notifications",
  ...
  upgrade: {
    ...
    trialAutoRenew: "After 7 days, the subscription will automatically renew at $18.99/month. Cancel at any time.",
    ...
    downloadCheckoutSavedForMinutes: "Saved for {minutes} min",
    downloadCheckoutDeleteWarning: "Your improved resume will be deleted after this time.",
    ...
    sandboxBenefitInterviewsTitle: "More interviews",
    sandboxBenefitInterviewsSub: "Stand out",
    sandboxBenefitInstantTitle: "Instant download",
    sandboxBenefitInstantSub: "Get started",
  ...
  admin: {
    ...
    email: {
      groups: {
        title: "Email groups",
        subtitle:
          "Everyone in the database (paginated). Filter by activity or search email. Columns show product usage and which automated sends we already recorded (post-optimize win-back + stagger campaigns).",
        linkAutomation: "Automation & send →",
        filterSearch: "Email contains",
        searchPlaceholder: "name@…",
        filterActivity: "Activity",
        activityAny: "All users",
        activityAnalyzed: "Did analyze",
        activityOptimized: "Did optimize",
        activityLoginOnly: "No analyze / no optimize yet",
        tableEmpty: "No users match these filters.",
        colEmail: "User",
        colActivity: "Product",
        colMarketing: "Marketing OK",
        marketingOn: "Yes",
        marketingOff: "No",
        colWinback: "Win-back sent",
        colStagger: "Stagger campaigns",
        colJoined: "Joined",
        footnote:
          "A / O = successful analyze or optimize in usage logs. Win-back counts rows with status “sent”. Stagger lists campaign_kind values from the one-shot stagger sent log. Manual “Quick send” is not listed here unless we add a separate log later.",
      },
      templates: {
    ...
    userDetail: {
      ...
      partnerAccessHelp:
        "Grants the partner referral dashboard. Toggle the checkbox, then save — the user will see Invite friends after refreshing the app or signing in again.",
      partnerAccessEnable: "Allow partner program",
      savePartnerAccess: "Save partner access",
    ...
    visualSandbox: {
      assessmentTitleLead: "Your resume is good, but we found",
      assessmentTitleHighlight: "key areas to improve.",
      assessmentSubtitle: "Fixing these will strengthen your match and increase interview chances.",
      currentMatch: "Current match",
      potentialMatch: "Potential match",
      improvementPotentialShort: "improvement potential",
      impactHigh: "High impact",
      impactMedium: "Medium impact",
      potentialBoost: "+{pct}% boost",
      /** Disclosure: grouped gaps by resume section (Technical Skills, etc.) — complements top recommendations. */
      seeGapBreakdown: "Gap breakdown by section ({count})",
      autoImproveBannerTitle: "Good news: With a few smart improvements, your match score can reach {pct}%.",
      autoImproveBullet1: "Better visibility",
      autoImproveBullet2: "More interviews",
      autoImproveBullet3: "Stronger offers",
      autoImproveBannerCta: "Apply improvements →",
      ...
      pdfIncludedHint: "PDF export is included with your plan.",
      showFewerIssues: "Show fewer",
      atsFriendlyLabel: "ATS-friendly",
      recommendationsEyebrow: "Recommendations",
      /** Assessment match columns — tier labels + short hints (sandbox thresholds). */
      matchTierExcellent: "Excellent",
      matchTierExcellentHint: "Strong alignment with screening signals for this role.",
      matchTierSolid: "Solid",
      matchTierSolidHint: "Good competitive baseline — small upgrades still lift replies.",
      matchTierNeedsRefinement: "Needs refinement",
      matchTierNeedsRefinementHint: "Noticeable gaps vs the posting — prioritize targeted fixes before calling it strong.",
      matchTierFair: "Fair",
      matchTierFairHint: "Surface-level fit — keywords and proof points still diverge from the role.",
      ...
      resultScoreBasedOn: "This score is based on:",
      resultScoreFactor1: "Skills match",
      resultScoreFactor2: "Keyword alignment",
      resultScoreFactor3: "Experience relevance",
      resultScoreFactor4: "Resume structure",
      resultScoreFactor5: "Impact & achievements",
      resultKeyChangesTitle: "Key changes we made",
      resultKeyChangesSubtitle: "Your resume is now stronger and better aligned with the job.",
      resultImprovementsApplied: "{count} improvements applied",
      resultImprovedLabel: "Improved",
      resultTopCandidatesBadge: "Top {pct}% candidates",
      expandIssueDetails: "What to change — full details",
    },
    app: {
      title: "App control",
